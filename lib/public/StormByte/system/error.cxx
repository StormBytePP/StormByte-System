...
const StormByte::Error::Category<StormByte::System::Error>& StormByte::System::category() noexcept {
	static StormByte::Error::Category<StormByte::System::Error> instance;
	return instance;
}

std::error_code StormByte::System::make_error_code(const Error e) noexcept {
